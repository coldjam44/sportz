...
<div class="row">
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="text-center my-4"> {{ trans('main_trans.sportsuser') }}</h3>
                <div class="text-right mb-3">
                    @can('create apartments')
                    <a href="{{ route('sportsusers.create') }}" class="btn-bid-now" style="color:white; cursor:pointer">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered data-table" id="data-table">
                        ...
                        <tbody>
                            ...
                            @foreach ($sportsusers as $sportsuser)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('sportsusers/' . $sportsuser->image) }}" width="50" height="50">
                                    </td>

                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit{{ $sportsuser->id }}"
                                            title="{{ trans('Counters_trans.Edit') }}"><i
                                                class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{ $sportsuser->id }}"
                                    ...
                                    <!-- edit_modal_Grade -->
                                    <div class="modal fade" id="edit{{ $sportsuser->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="{{ route('sportsusers.update',$sportsuser->id) }}" method="post" enctype="multipart/form-data">
                                                        {{ method_field('patch') }}
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input id="name_ar" type="text" name="name_ar"
                                                                    class="form-control"
                                                                    value="{{ $sportsuser->name_ar }}"
                                                                    required>
                                                                <input id="id" type="hidden" name="id"
                                                                    class="form-control" value="{{ $sportsuser->id }}">
                                                            </div>
                                                            <div class="col">
                                                                <label for="name_en"
    ...
    {{-- //////////////////////////////////// --}}
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete{{ $sportsuser->id }}" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('sportsusers.destroy',$sportsuser->id)}}" method="post">
                                                        {{method_field('Delete')}}
                                                        @csrf
                        ...
                        {{ $sportsusers->links('pagination::bootstrap-5') }}
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- add_form -->
                        <form action="{{ route('sportsusers.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col">
